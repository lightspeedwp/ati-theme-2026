...
<h3 class="wp-block-heading has-text-align-center has-base-color has-text-color has-400-font-size" style="border-top-left-radius:0;border-top-right-radius:0;border-bottom-left-radius:0;border-bottom-right-radius:0;font-style:normal;font-weight:500">Safari</h3>
<!-- /wp:heading -->

<!-- wp:paragraph {"className":"hidden-excerpt","style":{"typography":{"textAlign":"center","fontStyle":"normal","fontWeight":"300"}},"textColor":"base","fontSize":"200"} -->
<p class="has-text-align-center hidden-excerpt has-base-color has-text-color has-200-font-size" style="font-style:normal;font-weight:300"><strong>Ook zo gek op de wilde dieren van Afrika? Hier vind je reizen waar je de Big Five kunt spotten.</strong></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div></div>
<!-- /wp:cover -->
